...
enum L10n {
    ...
    private static let chinese: [String: String] = [
        ...
        "admin.staleLog": "检测到旧版 MacFan 日志（含 nohup）。请完全退出旧版，从官网下载 v1.1.4 并拖到「应用程序」后再授权。",
    ...
    private static let english: [String: String] = [
        ...
        "admin.staleLog": "Stale log from an old MacFan (nohup). Quit the old app, install v1.1.4 from the website into Applications, then authorize again.",
