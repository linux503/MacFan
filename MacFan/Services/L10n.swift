...
enum L10n {
    ...
    private static let chinese: [String: String] = [
        ...
        "admin.debugBuild": "当前跑的是 Xcode Debug 包，不是官网安装版。请完全退出所有 MacFan，从官网下载最新版拖到「应用程序」后再授权。",
        "admin.staleLog": "这是旧版 MacFan（含 nohup）。请完全退出所有 MacFan，从官网下载最新版拖到「应用程序」后再授权。",
    ...
    private static let english: [String: String] = [
        ...
        "admin.debugBuild": "This is an Xcode Debug build, not the website download. Quit every MacFan copy, install the latest build into Applications, then authorize again.",
        "admin.staleLog": "This is an old MacFan (nohup). Quit every MacFan copy, download the latest build into Applications, then authorize again.",
