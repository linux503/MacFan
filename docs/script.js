(() => {
  ...
  const dict = {
    zh: {
      ...
      "stat.arch": "芯片架构",
      "showcase.tag": "界面",
      "showcase.title": "原生界面，信息一目了然",
      "showcase.sub": "深色 Signal Night 主题还原真实 App——侧边栏切模式，主面板看温度、风扇与曲线。",
      "gallery.dash": "主界面 · 实机读数",
      "gallery.dashHint": "Dashboard",
      "gallery.modes": "四种控制方式",
      "gallery.scenes": "六种开箱场景",
      "gallery.panorama": "Dashboard 全景 · 授权卡片 + 温度曲线",
      "gallery.panoramaHint": "Universal Binary · macOS 14+ · SwiftUI",
      "features.tag": "控制",
    ...
    en: {
      ...
      "showcase.title": "Native UI, information at a glance",
      "showcase.sub": "Signal Night theme matches the real app — sidebar modes, dashboard temps, fans, and curves.",
      "gallery.dash": "Dashboard · live readings",
      "gallery.dashHint": "Dashboard",
      "gallery.modes": "Four control modes",
      "gallery.scenes": "Six built-in scenes",
      "gallery.panorama": "Dashboard panorama · auth card + temp curve",
      "gallery.panoramaHint": "Universal Binary · macOS 14+ · SwiftUI",
