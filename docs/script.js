(() => {
  ...
  const dict = {
    zh: {
      ...
      "nav.start": "开始",
      "nav.download": "下载",
      "hero.badge": "v1.1 · Universal Binary · 深浅主题",
      ...
      "showcase.sub": "侧边栏切换模式，主面板看温度、风扇与曲线——深浅双主题，白天夜晚都舒服。",
      ...
      "arch.sub": "Universal Binary 同时服务 Apple Silicon 与 Intel。芯片感知 SMC 键值、菜单栏快捷入口、深浅双主题。",
      "arch.theme": "深浅主题",
      "start.tag": "开始",
      "start.title": "三步上手",
    ...
    en: {
      ...
      "hero.badge": "v1.1 · Universal Binary · Dark & Light",
      ...
      "showcase.sub": "Sidebar for modes, dashboard for temps and fans — dark & light themes for any hour.",
      ...
      "arch.sub": "Universal Binary for Apple Silicon & Intel. Chip-aware SMC, menu bar shortcuts, dark & light themes.",
      "arch.theme": "Dark & Light",
