(() => {
  ...
  const dict = {
    zh: {
      ...
      "showcase.sub": "Arctic Ice 深色主题还原真实 App——侧边栏切模式，主面板看温度、风扇与曲线。",
    ...
    en: {
      ...
      "showcase.sub": "Arctic Ice theme matches the real app — sidebar modes, dashboard temps, fans, and curves.",
